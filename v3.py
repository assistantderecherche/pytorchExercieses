...
#
## hyperparameters before I switched to ones used in gpt.py below
#
...
#
#   Something's wrong here in comparison:
#
...
m = model.to(device)
total_par = sum([p.numel() for p in m.parameters()])/1e6
print(f"Total of {round(total_par, 2)}M parameters")
